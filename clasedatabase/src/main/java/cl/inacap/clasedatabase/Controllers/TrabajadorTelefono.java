...
/**
 * Servlet implementation class TrabajadorTelefono
 */
@WebServlet("/TrabajadorTelefono.do")
public class TrabajadorTelefono extends HttpServlet {
		...
		if(!telefono.equals("")) {
			...
			for(Trabajador trabajador : trabajadores) {
				if (trabajador.getRut() == rut) {
					...
					telefonosCliente = trabajador.getTelefonos();
					telefonosCliente.add(addTelefono);
					trabajadorFinal.setTelefonos(telefonosCliente);
